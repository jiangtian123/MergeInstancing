...
namespace Unity.MergeInstancingSystem
{
    public class LODSlider
    {
        ...
        private LODSliderRang m_DefaultRange = null;

        private List<LODSliderRang> m_RangeList = new List<LODSliderRang>();
        ...
        public LODSlider(bool useDefault = false, string name = "")
        {
            if (useDefault == true)
            {
                var defaultRange = new LODSliderRang();
