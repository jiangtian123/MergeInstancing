...
namespace Unity.MergeInstancingSystem.DebugWindow
{
    public class InstanceItem: VisualElement, IDisposable
    {
        ...
        public InstanceItem(InstanceDebugWindow window)
        {
        ...
        public void BindData(InstanceItemData data)
        {
            m_data = data;
